          ...
          <div className="profile-nav col-md-3">
            <div className="panel">
              <div className="user-heading round">
                <a href="#">
                  <img src={`http://localhost:8000/images/${expert.photo}`} alt="" />
                </a>
            ...
            <div className="panel">
              ...
              "Passionné par l'automobile depuis toujours, je suis là pour vous offrir une expertise personnalisée et vous guider vers le véhicule parfaitement adapté à vos besoins et à votre style de vie. Faites de chaque achat une expérience unique et sans souci."
              </div>
              <div className="panel-body bio-graph-info">
                <h1>Informations</h1>
                <div className="row">
                  <div className="bio-row">
                    <p><span>Nom </span>: {expert.Nom}</p>
                  </div>
                  <div className="bio-row">
                    <p><span>Prénom </span>: {expert.Prenom}</p>
                  </div>
                  
                  <div className="bio-row">
                    <p><span>Adresse</span>: {expert.Adresse}</p>
                  </div>
                  ...
                  <div className="bio-row">
                    <p><span>Téléphone </span>: {expert.Numéro}</p>
                  </div>
                  <div className="bio-row">
                    <p><span>Spécialité </span>: {expert.ExpertId.spécialité}</p>
                  </div>
                  <div className="bio-row">
                    <p><span>Expérience </span>: {expert.ExpertId.experience}</p>
                  </div>
                  <div className="bio-row">
                    <p><span>Prix </span>: {expert.ExpertId.prix}</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="panel-body">
                  <div className="bio-chart">
                    <div style={{ display: 'inline', width: '100px', height: '100px' }}>
                      ...
                      <input className="knob" data-width="100" data-height="100" data-displayprevious="true" data-thickness=".2"  data-fgcolor="#e06b7d" data-bgcolor="#e8e8e8" style={{ width: '54px', height: '33px', position: 'absolute', verticalAlign: 'middle', marginTop: '33px', marginLeft: '-77px', border: '0px', fontWeight: 'bold', fontStyle: 'normal', fontVariant: 'normal', fontStretch: 'normal', fontSize: '20px', lineHeight: 'normal', fontFamily: 'Arial', textAlign: 'center', color: 'rgb(224, 107, 125)', padding: '0px', WebkitAppearance: 'none', background: 'none' }} />
                    </div>
                  </div>
                  <div className="bio-desk">
                    <h4 className="red">Nombre de jobs acceptés</h4>
                    <p>{jobsCountByExpert ? jobsCountByExpert : 'Chargement...'}</p>
                  </div>
                </div>
              </div>
            </div>
