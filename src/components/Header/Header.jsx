          ...
          <Row>
            ...
            <Col lg="6" md="6" sm="6">
              <div className="header__top__right d-flex align-items-center justify-content-end gap-3">
                {isLoggedIn ? (
                  <>
                    <Link to="/profile" className="d-flex align-items-center gap-1 profile_icon">
                      <i className="ri-user-line"></i> {userData && userData.Nom && userData.Prenom ? `${userData.Nom} ${userData.Prenom}` : "Profile"}
                    </Link>
                    <button onClick={handleLogout} className="btn btn-link">Déconnecter</button>
                  </>
                ) : (
                  <>
